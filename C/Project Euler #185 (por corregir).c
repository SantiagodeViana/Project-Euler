...
int main()
{
    long long int guesses[N-1][2] = {{5616185650518293, 2}, {3847439647293047, 1}, {5855462940810587, 3}, {9742855507068353, 3}, {4296849643607543, 3},
    ...
    for (int i = 0; i < N; i++){
        ...
        for (int j = 0; j < N; j++){
            ...
            printf("%lld", guesses[i][0] - guesses[j][0]);
            getchar();
        }
    }
